...
echo ""
echo "  \${_bold}Optional — live context strips for Claude Code sessions:\${_reset}"
echo ""
echo "      git clone git@github.com:dupe-com/sitrep.git ~/Work/sitrep"
echo "      ~/Work/sitrep/install.sh --remote \${SSH_ALIAS}"
echo ""
echo "  Then every 'claude' you start shows a live strip underneath: your ask,"
echo "  status, and what's done / happening / next."
echo ""
hr
echo ""
SCRIPT
